...
const BLUEPRINTS: readonly Blueprint[] = [
  ...
  },
  {
    ...
    solLine:
      "水路ができたか！畑にも綺麗な水が行き届くな。……でも北の風車と南の水路、まだバラバラで効率が悪そうじゃないか？あっ、また先走ったか。",
    lunaLine:
      "ふふ、焦らないでソル。受付の子も『もうすぐ繋がる』って目を輝かせてたわ。明日、あの計画が動く合図よ。",
  },
  {
    ...
    solLine: "やったぜ！風と水が繋がって、街そのものが動き出した！……ちょっと泣きそう。言ってないからな。",
    lunaLine:
      "ついに循環街が生まれたの。スロットも1つ解放されたわ。購読でパワーを送り続けてくれたみんな——受付の子も、今日はずっと笑顔だった。",
  },
  {
    id: "star-observatory",
    name: "星詠み観測塔",
...
【リアル】みんなの応援エネルギー（BOINC）で、後方の街が育っています。
【物語】最前線から帰った2人が、夕暮れの広場で見るのは——伸びた屋根と、受付窓口の明かり。
...
（余談）ギルド受付の子は、進捗ボードを見て「今日も街が少し大きくなったね」と微笑む。優しいよね。ちょっと気になる。`;
}
