...
export const FEATURE_LABELS: Record<string, string> = {
  ...
  "works-news-search": "WORKS ニュースサーチ",
  "works-news-search-chat": "WORKS ニュースサーチ相談",
  "works-news-search-enrich": "WORKS ニュースサーチ解説",
  "works-money-flow": "WORKS 行政・お金の流れ",
  "judicial-case-chat": "WORKS 訴訟記録ノート",
  "soluna-sol-chat": "Soluna ソル会話",
  "soluna-luna-chat": "Soluna ルーナ会話",
  "soluna-memory": "Soluna 記憶抽出",
  "space-chat": "宇宙 AI 解説",
...
export const FEATURE_APP_MAP: Record<string, AppKey> = {
  ...
  "soluna-sol-chat": "soluna",
  "soluna-luna-chat": "soluna",
  "soluna-memory": "soluna",
  "space-chat": "space",
  "space-apod-ja": "space",
  watches: "stocks",
  "watch-detail": "stocks",
