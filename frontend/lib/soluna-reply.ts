 ...
 * 首相に限らず、いまの事実・数値・動向・炎上を広く拾う。
 */
export const WORLD_INFO_RE =
  /ニュース|最新|最新情報|世間|世の中|トレンド|話題|SNS|ツイッター|Twitter|\bX\b|インスタ|Instagram|Reddit|速報|いま何|今何|最近の|今日の|明日の|あしたの|きょうの|いまの|今の|現在の|現状|動向|どうなってる|どうなった|何が起き|何があった|調べて|検索して|ネットで|ウェブで|Webで|ググ|円安|円高|円相場|日経|為替|株価|相場|いくら|何円|価格|選挙|地震|台風|天気|天候|予報|気温|降水|晴れ|くもり|曇り|雨|雪|戦争|停戦|炎上|バズ|発表|リリース|気象|傘|服装|首相|総理|大統領|内閣|大臣|知事|市長|現職|誰|だれ|何歳|就任|当選|オリパ|五輪|オリンピック|ワールドカップ|試合|スコア|優勝|敗退|bitcoin|ビットコイン|BTC|イーサ|Ethereum|ドル円|金価格|原油|コロナ|COVID|停戦合意|政権|与党|野党|国会|皇室|天皇|新内閣|組閣|訃報|事件|事故|開幕|終了|いつから|いつまで|公式発表/i;
...
export function isWorldInfoQuestion(message: string): boolean {
  ...
  // 「〇〇は誰／いくら／いつ」系の短文事実質問
  return /(?:は|って|の)(誰|だれ|何人|いつ|いくら|何円|どこ|何位)/.test(text);
}
