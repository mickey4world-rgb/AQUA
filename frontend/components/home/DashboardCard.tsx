...
type DashboardCardProps = {
  ...
  href: string;
  icon: string;
  accent: "cyan" | "fuchsia" | "amber" | "violet" | "blue" | "indigo";
  tag: string;
};
...
const accentStyles = {
  ...
  indigo: {
    ...
    glow: "from-indigo-500/20 via-violet-500/5 to-transparent",
    icon: "border-indigo-400/30 bg-indigo-500/10 text-indigo-300",
