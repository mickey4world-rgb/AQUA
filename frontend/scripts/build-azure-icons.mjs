...
const map = {
  ...
  subnet: "02742-icon-service-Subnet.svg",
  "private-endpoint": "02579-icon-service-Private-Endpoints.svg",
  "private-link": "00427-icon-service-Private-Link.svg",
  bastion: "02422-icon-service-Bastions.svg",
  "nat-gateway": "10310-icon-service-NAT.svg",
  "public-ip": "10069-icon-service-Public-IP-Addresses.svg",
  "route-table": "10082-icon-service-Route-Tables.svg",
  "vpn-gateway": "10063-icon-service-Virtual-Network-Gateways.svg",
  expressroute: "10079-icon-service-ExpressRoute-Circuits.svg",
  "dns-zone": "10064-icon-service-DNS-Zones.svg",
